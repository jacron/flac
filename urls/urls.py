...
urlpatterns = [
    ...
    url(r'^librarycode/listrange/(?P<code>.+)/(?P<crange>.+)/(?P<instrument_id>.+)/$',
        views.list_librarycoderange,
        name='librarycodelistrange'),
    url(r'^librarycode/listrange/(?P<code>.+)/(?P<crange>.+)/$',
        views.list_librarycoderange,
        name='librarycodelistrange'),
    url(r'^librarycode/list/(?P<code>.+)/(?P<instrument_id>.+)/instrument/$',
        views.list_librarycode_instrument,
        name='librarycodelistinstrument'),
    url(r'^librarycode/list/(?P<code>.+)/(?P<favorite>.+)/favorite/$',
        views.list_librarycode_favorite,
        name='librarycodelistfavorite'),
    url(r'^librarycode/list/(?P<code>.+)/$',
        views.list_librarycode,
        name='librarycodelist'),
    url(r'^librarycode/(?P<librarycode>.+)/(?P<code>.+)/$',
